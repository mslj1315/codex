...
describe("developmentContextResolver", () => {
  ...
  it("rejects emulator, private, and public source addresses with the marker", async () => {
    for (const ip of ["10.0.2.2", "10.0.2.16", "10.0.2.15", "10.1.0.1", "192.168.1.20", "172.16.0.1", "203.0.113.10"]) {
